...
//
// use app.get to create a route proj
//

//creates a http server at port 8020, that loads all the files.  I want
// it to also serve load a file, then the classes in the file are
// avaialble if they are exported.

console.log(k_portnum);
...
//also statically serve the file in the folder
...
//var agentPlayer = require("./entrypoint.js");
//console.log("wooho I got the" + agentPlayer.d());
