...
return (function (){
if(cljs.core.truth_((function (){var and__4208__auto__ = clojure.browser.repl.load_queue;
...
var script__$1 = (function (){var G__5996 = script;
(G__5996["type"] = "text/javascript");

(G__5996["onload"] = onload);

(G__5996["onreadystatechange"] = onload);

return G__5996;
})();
var script__$2 = (((opt_sourceText == null))?(function (){var G__5997 = script__$1;
(G__5997["src"] = src);

return G__5997;
})():(function (){var G__5998 = script__$1;
goog.dom.setTextContext(G__5998,opt_sourceText);
...
var reload_QMARK_ = (function (){var or__4220__auto__ = reload;
...
var path_5999 = (goog.dependencies_.nameToPath[src]);
delete goog.dependencies_.visited[path_5999];

delete goog.dependencies_.written[[cljs.core.str(goog.basePath),cljs.core.str(path_5999)].join('')];
} else {
}
